...
<head>
    ...
    <title>Kolkata 2 Dhaka | Dashboard</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="admin/dist/img/logo.png" alt="AdminLTE Logo" class="  elevation-3"
                    style="opacity: .8; background-color:azure; width:235px; height: 65px; padding: 10px;">
                <br>
                {{-- <span class="brand-text font-weight-light ">Kolkata 2 Dhaka</span> --}}
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="admin/dist/img/tiny-logo.png" class="img-circle elevation-2" style="background-color: wheat;"
                            alt="User Image">
                    </div>
                    <div class="info">
